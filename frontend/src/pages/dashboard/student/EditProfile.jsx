 ...
 * Fetches the real profile on mount (GET /api/student/profile) and
 * saves changes back with PUT /api/student/profile.
 */
export default function EditProfile() {
  ...
  // File is selected -> show an instant local preview, then upload
  // immediately to the multer endpoint (POST /student/profile/avatar).
          ...
          <div className="bg-white rounded-2xl p-6 text-center">
            <div className="relative inline-block mb-4">
              ...
              <label className="absolute bottom-0 right-0 h-8 w-8 bg-primary rounded-full flex items-center justify-center cursor-pointer border-2 border-white">
                ...
                <input type="file" accept=".png,.jpg,.jpeg,.webp" onChange={handleAvatarUpload} className="hidden" />
              </label>
            </div>
